      ...
      <section className="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            >
              Upload your research papers and get instant AI-generated
              summaries, ask questions, and gain deeper insights into your
              academic work.
            </p>
            <div
            ...
            >
              <Link to="/upload">
                <Button
                  size="lg"
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 transform"
                >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Transform how you interact with research papers using cutting-edge
              AI technology
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card
              className="hover:shadow-lg transition-all duration-300 hover:scale-105 transform animate-fade-in"
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Simply upload your PDF research papers and our AI will
                  automatically process and analyze the content
                </p>
              </CardContent>
            </Card>
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Get organized summaries with key sections: methodology,
                  results, conclusions, and more
                </p>
              </CardContent>
            </Card>
            <Card
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Ask natural language questions about your papers and get
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Join researchers worldwide who are saving hours of time with
            AI-powered analysis
          </p>
          <Link to="/upload">
            <Button
              size="lg"
              className="bg-white text-blue-600 hover:bg-gray-50 px-8 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 transform"
            >
